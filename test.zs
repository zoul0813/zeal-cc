...
h:/bin/cc_parse h:/tests/array.c h:/tests/array.ast
: echo Failed to parse h:/tests/array.c
? h:/bin/cc_codegen h:/tests/array.ast h:/tests/array.asm
...
echo TEST: h:/tests/array_char.c
h:/bin/cc_parse h:/tests/array_char.c h:/tests/array_char.ast
: echo Failed to parse h:/tests/array_char.c
? h:/bin/cc_codegen h:/tests/array_char.ast h:/tests/array_char.asm
: echo Failed to codegen h:/tests/array_char.ast
? zealasm h:/tests/array_char.asm h:/tests/array_char.bin
? return tests/array_char.bin
: echo Failed to assemble h:/tests/array_char.asm
: echo Failed to compile tests/array_char.c

echo TEST: h:/tests/array_ptr.c
h:/bin/cc_parse h:/tests/array_ptr.c h:/tests/array_ptr.ast
: echo Failed to parse h:/tests/array_ptr.c
? h:/bin/cc_codegen h:/tests/array_ptr.ast h:/tests/array_ptr.asm
: echo Failed to codegen h:/tests/array_ptr.ast
? zealasm h:/tests/array_ptr.asm h:/tests/array_ptr.bin
? return tests/array_ptr.bin
: echo Failed to assemble h:/tests/array_ptr.asm
: echo Failed to compile tests/array_ptr.c

echo TEST: h:/tests/assign.c
h:/bin/cc_parse h:/tests/assign.c h:/tests/assign.ast
: echo Failed to parse h:/tests/assign.c
? h:/bin/cc_codegen h:/tests/assign.ast h:/tests/assign.asm
...
h:/bin/cc_parse h:/tests/char.c h:/tests/char.ast
: echo Failed to parse h:/tests/char.c
? h:/bin/cc_codegen h:/tests/char.ast h:/tests/char.asm
...
h:/bin/cc_parse h:/tests/comp.c h:/tests/comp.ast
: echo Failed to parse h:/tests/comp.c
? h:/bin/cc_codegen h:/tests/comp.ast h:/tests/comp.asm
...
h:/bin/cc_parse h:/tests/compares.c h:/tests/compares.ast
: echo Failed to parse h:/tests/compares.c
? h:/bin/cc_codegen h:/tests/compares.ast h:/tests/compares.asm
...
h:/bin/cc_parse h:/tests/do_while.c h:/tests/do_while.ast
: echo Failed to parse h:/tests/do_while.c
? h:/bin/cc_codegen h:/tests/do_while.ast h:/tests/do_while.asm
...
h:/bin/cc_parse h:/tests/expr.c h:/tests/expr.ast
: echo Failed to parse h:/tests/expr.c
? h:/bin/cc_codegen h:/tests/expr.ast h:/tests/expr.asm
...
h:/bin/cc_parse h:/tests/for.c h:/tests/for.ast
: echo Failed to parse h:/tests/for.c
? h:/bin/cc_codegen h:/tests/for.ast h:/tests/for.asm
...
h:/bin/cc_parse h:/tests/global.c h:/tests/global.ast
: echo Failed to parse h:/tests/global.c
? h:/bin/cc_codegen h:/tests/global.ast h:/tests/global.asm
...
h:/bin/cc_parse h:/tests/if.c h:/tests/if.ast
: echo Failed to parse h:/tests/if.c
? h:/bin/cc_codegen h:/tests/if.ast h:/tests/if.asm
...
h:/bin/cc_parse h:/tests/math.c h:/tests/math.ast
: echo Failed to parse h:/tests/math.c
? h:/bin/cc_codegen h:/tests/math.ast h:/tests/math.asm
...
h:/bin/cc_parse h:/tests/params.c h:/tests/params.ast
: echo Failed to parse h:/tests/params.c
? h:/bin/cc_codegen h:/tests/params.ast h:/tests/params.asm
...
h:/bin/cc_parse h:/tests/pointer.c h:/tests/pointer.ast
: echo Failed to parse h:/tests/pointer.c
? h:/bin/cc_codegen h:/tests/pointer.ast h:/tests/pointer.asm
...
h:/bin/cc_parse h:/tests/simple_return.c h:/tests/simple_return.ast
: echo Failed to parse h:/tests/simple_return.c
? h:/bin/cc_codegen h:/tests/simple_return.ast h:/tests/simple_return.asm
...
h:/bin/cc_parse h:/tests/struct.c h:/tests/struct.ast
: echo Failed to parse h:/tests/struct.c
? h:/bin/cc_codegen h:/tests/struct.ast h:/tests/struct.asm
...
h:/bin/cc_parse h:/tests/ternary.c h:/tests/ternary.ast
: echo Failed to parse h:/tests/ternary.c
? h:/bin/cc_codegen h:/tests/ternary.ast h:/tests/ternary.asm
...
h:/bin/cc_parse h:/tests/unary.c h:/tests/unary.ast
: echo Failed to parse h:/tests/unary.c
? h:/bin/cc_codegen h:/tests/unary.ast h:/tests/unary.asm
...
h:/bin/cc_parse h:/tests/while.c h:/tests/while.ast
: echo Failed to parse h:/tests/while.c
? h:/bin/cc_codegen h:/tests/while.ast h:/tests/while.asm
...
h:/bin/cc_parse h:/tests/return16.c h:/tests/return16.ast
: echo Failed to parse h:/tests/return16.c
? h:/bin/cc_codegen h:/tests/return16.ast h:/tests/return16.asm
...
h:/bin/cc_parse h:/tests/zealos.c h:/tests/zealos.ast
: echo Failed to parse h:/tests/zealos.c
? h:/bin/cc_codegen h:/tests/zealos.ast h:/tests/zealos.asm
