...
extern const char CG_STR_DB_ZERO[];
extern const char CG_STR_COLON_DW[];
extern const char CG_STR_COLON_DB[];
extern const char CG_STR_COLON_DW_ZERO[];
extern const char CG_STR_COLON_DB_ZERO[];
