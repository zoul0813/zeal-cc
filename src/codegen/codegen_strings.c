...
const char CG_STR_DB_ZERO[] = "  .db 0\n";
const char CG_STR_COLON_DW[] = ":\n  .dw ";
const char CG_STR_COLON_DB[] = ":\n  .db ";
const char CG_STR_COLON_DW_ZERO[] = ":\n  .dw 0\n";
const char CG_STR_COLON_DB_ZERO[] = ":\n  .db 0\n";
const char CG_STR_IX_PLUS[] = "ix+";
